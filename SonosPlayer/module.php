...
class SonosPlayer extends IPSModule
{
    ...
    public function ApplyChanges()
    {
        ...
        if ($Model == 'Move' || $Model == 'Move 2' || $Model == 'Roam' || $Model == 'Roam 2' || $Model == 'Roam SL') {
    ...
    public function GetConfigurationForm()
    {
        ...
        $knownModels = [
            ...
            ['caption' => 'Era 100',     'value' => 'Era 100'],
            ['caption' => 'Era 300',     'value' => 'Era 300'],
            ['caption' => 'Move',        'value' => 'Move'],
            ['caption' => 'Move 2',      'value' => 'Move 2'],
            ...
            ['caption' => 'Roam 2',      'value' => 'Roam 2'],
            ['caption' => 'Roam SL',     'value' => 'Roam SL'],
